...
public class WorriorPattern {
    ...
    {
       // UnitAABB(Vec2F myvect, Vec2F enemyvect, float myarea, float enemyarea
        if(Bounding.UnitAABB(a.m_battleBounding.m_position, a.my_enemy.m_battleBounding.m_position, a.m_battleBounding.GetRadius(), a.my_enemy.m_battleBounding.GetRadius()))
        {
            if(a.my_enemy.mHp<=0)
            {
                a.setState(UnitValue.S_REMOVE);
